...
(function () {
    ...
    module.exports.mediumCssUrls = [
        ...
        '/plugins/css/medium-bootstrap.css'
    ];
    ...
    module.exports.externalJS = [
        'elements/js/builder_in_block.js'
    ];
            ...
            if( publish.publishActive === 0 ) {//check if we're currently publishing anything
                ...
                if( siteBuilder.site.pendingChanges === true ) {//we've got changes, save first
                    ...
                    $('#pages li:visible').each(function(){
                        ...
                        var theRow = $('<tr><td class="text-center" style="width: 30px;"><label class="checkbox no-label"><input type="checkbox" value="'+thePage+'" id="" data-type="page" name="pages[]" data-toggle="checkbox"></label></td><td>'+thePage+'<span class="publishing"><span class="working">Publishing... <img src="'+appUI.baseUrl+'plugins/sitebuilder/images/publishLoader.gif"></span><span class="done text-primary">Published &nbsp;<span class="fui-check"></span></span></span></td></tr>');
