    ...
    <div class="col-xl-4 p0">
      <div class="card m-b-30 text-center equalheight">
          <div class="card-body">
              ...
              <h3 class="font-light"> Business Site Builder</h3>
              <p>With Webitix you can create a professional responsive website for your business that will be fully integrated with the Webitix Platform. Select and customize a design from our platform that fits with your business or easily create your own with your desired colors, photos, and logo using our business site builder.</p>
          </div>
      </div>
    </div>      
