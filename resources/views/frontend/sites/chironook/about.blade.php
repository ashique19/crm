@extends('layouts.app')
@section('title')
    <title>About Us | ChiroNook</title>
    <meta name="title" content="About ChiroNook">
    <meta name="description" content="ChiroNook is a chiropractic website and client management chiropractor software. Check out a free demo of ChiroNook Today to learn how to grow your chiropractic client list!">
    <meta name="author" content="{{ env('APP_DOMAIN') }} ">
    <meta property="og:title" content="About ChiroNook" />
    <meta property="og:image" content="{{ url('assets/images/features-1-1.jpg') }}" />
    <meta property="og:description" content="ChiroNook is a chiropractic website and client management chiropractor software. Check out a free demo of ChiroNook Today to learn how to grow your chiropractic client list!">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-12 col-xs-12 text-center-md">
                <div class="about-box gradient-one">
                    <div class="inner">
                        <img src="{{ url('assets/images/features-1-1.jpg') }}" alt="ChiroNook" class="img-fluid">
                    </div><!-- /.inner -->
                </div><!-- /.about-box -->
            </div><!-- /.col-md-6 -->
            <div class="col-md-6 col-sm-12 col-xs-12">
                <div class="feature-content">
                    <h1 class="mb-1 font-light2">About ChiroNook</h1>
                    <p>ChiroNook is working with large chiropractic institutions down to single chiropractic providers to give them the ability to help their clients on-line, affordably and securely. Our extensive experience in this area, combined with our unique chiropractic based technology and very affordable pricing makes us a natural choice to take your chiropractic practice to the next level.</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 default info">
                    <h2 class="mb-1 font-light2">The Software Platform<br>Designed for Chiropractors</h2>
                    <p>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-12 col-xs-12 pull-right text-right">
                <div class="about-box gradient-two">
                    <div class="inner">
                        <img src="{{ url('assets/images/features-1-2.jpg') }}" alt="ChiroNook" class="img-fluid">
                    </div><!-- /.inner -->
                </div><!-- /.about-box -->
            </div><!-- /.col-md-6 -->           
            <div class="col-md-6 col-sm-12 col-xs-12 pull-right">
                <div class="feature-content">
                    ...
                    <p>ChiroNook's mission is to give you the tools you need to succeed. Designed to work with individuals and larger practices seeking to expand their services on-line, the system gives you everything you need; seamless integration with your web site, on-line scheduling, triage functionality for new chiropractic clients, provider selection, different on-line payment options; a whole suite of systems such as synchronous and asynchronous chat that can help you take your practice to the next level.</p>
      ...
      <div class="icon_wraper row">
         <div class="col-md-6 col-sm-6 wow fadeIn">
           <div class="text-center mt-5">
            ...
            <p class="no_bottom">Over the next few years the way chiropractic communicate with their clients and potential clients will change dramatically. This will have profound implications for the future of your business. Organizations that take advantage of the new paradigm will thrive and those that don’t will wither.</p>
           </div>
         </div>
         <div class="col-md-6 col-sm-6 wow fadeIn">
           <div class="text-center mt-5">
         ...
         <div class="col-md-6 col-sm-6 wow fadeIn">
           <div class="text-center mt-5">
            ...
            <p class="no_bottom">Nothing beats an in-person meeting with your client to solidify and build the relationship, but either you or the  chiropracticclient has to invest significant time and hassle to make it happen. Now with ChiroNook consutling tool, it is easy.</p>
           </div>
         </div>
         <div class="col-md-6 col-sm-6 wow fadeIn">
           <div class="text-center mt-5">
            ...
            <p class="no_bottom">Expand your chiropractic practice's footprint. By introducing online webcam consulting as an option to your chiropractic practice, you can grow your chiropractic client base exponentially. Even far-flung chiropractic clients can have the same close, personal relationship as your local clients.</p>
           </div>
         </div>        
      </div>
   </div>
