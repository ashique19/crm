    ...
    <div class="col-xl-4 p0">
      <div class="card m-b-30 text-center equalheight">
          <div class="card-body">
              ...
              <h3 class="font-light"> Chiropractic Site Builder</h3>
              <p>With ChiroNook you can create a professional responsive chiropractic website for your practice that will be fully integrated with the ChiroNook Platform. Select and customize a design from our platform that fits with your practice or easily create your own with your desired colors, photos, and logo using our chiropractic site builder.</p>
          </div>
      </div>
    </div>      
