 ...
 <section class="section-bg-image bg-top pb-4 content-background">
        <div class="container content">
            <div class="row vertical-row pt-5">
                <div class="col-md-7">
                    <img src="{{ url('assets/images/sites/'.strtolower(Config::get('app.name')).'/box-1.png') }}" alt="Integrated Online Booking" data-anima="" data-time="1000" aid="0.16243697744454222" class="fade-left img-fluid">
                </div>
                <div class="col-md-5">
            ...
            <div class="row vertical-row pt-5">
                ...
                <div class="col-md-6 order-first order-md-2">
                    <img src="{{ url('assets/images/sites/'.strtolower(Config::get('app.name')).'/box-2.png') }}" alt="Grow Your Practice" data-anima="" data-time="1000" aid="0.0063235023049657" class="fade-right img-fluid">
                </div>
            </div>
        </div>
