    ...
    <div class="col-xl-4 p0">
      <div class="card m-b-30 text-center equalheight">
          <div class="card-body">
              ...
              <h3 class="font-light"> Personal Trainer Site Builder</h3>
              <p>With TrainerNook you can create a professional responsive personal training website for your business that will be fully integrated with the TrainerNook Platform. Select and customize a design from our platform that fits with your business or easily create your own with your desired colors, photos, and logo using our personal training site builder.</p>
          </div>
      </div>
    </div>      
