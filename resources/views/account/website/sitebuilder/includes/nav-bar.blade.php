<nav class="mainnav navbar navbar-inverse navbar-embossed navbar-fixed-top" role="navigation" id="mainNav">
	<div class="navbar-header">
		...
		<a class="navbar-brand" href="">
			<b class='text-primary'>SITE</b>BUILDER
		</a>
	</div>
	<div class="collapse navbar-collapse" id="navbar-collapse-01">
		<ul class="nav navbar-nav">
			...
			@else
			<li class="{{ Request::path() ==  'dashboard' ? 'active' : ''  }}"><a href="{{ route('account.sitebuilder.dashboard') }}"><span class="fui-windows"></span> Sites</a></li>
			<li class="{{ Request::path() ==  'assets' ? 'active' : ''  }}"><a href="{{ route('account.sitebuilder.assets') }}"><span class="fui-image"></span> Image Library</a></li>
			@if (Auth::user()->type == 'admin')
			<li class="{{ Request::path() ==  'users' ? 'active' : ''  }}"><a href="{{ route('account.sitebuilder.users') }}"><span class="fui-user"></span> Users</a></li>
			<li class="{{ Request::path() ==  'settings' ? 'active' : ''  }}"><a href="{{ route('account.sitebuilder.settings') }}"><span class="fui-gear"></span> Settings</a></li>
			@endif
			@endif
		</ul>
