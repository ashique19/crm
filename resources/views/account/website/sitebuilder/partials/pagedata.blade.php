<form class="form-horizontal" role="form" id="pageSettingsForm" action="{{ route('account.sitebuilder.updatePageData') }}">
	...
	<div class="optionPane">
		...
		<div class="form-group">
			<label for="name" class="col-sm-3 control-label">Footer Includes:</label>
			<div class="col-sm-9">
				<textarea class="form-control" id="pageData_footerIncludes" name="pageData_footerIncludes" rows="7" placeholder="Additional code you'd like to include in the <footer> section">{{ $data['index']['footer_includes'] }}</textarea>
			</div>
		</div>
		<div class="form-group">
