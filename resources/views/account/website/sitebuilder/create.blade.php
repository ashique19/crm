...
<body class="builderUI">
    ...
    <div id="builder">
            ...
            <header class="clearfix affix">
                ...
                <div class="btn-group" style="float: right;">
                    ...
                    <ul class="dropdown-menu dropdown-menu-inverse dropdown-menu-right">
                        ...
                        <li>
                            <a href="#siteSettings" id="siteSettingsButton" class="siteSettingsModalButton" data-siteid="{{ $data['siteData']['site'][0]['id'] }}">
						...
						@endif
                        <li>
                            <a href="#pageSettingsModal" id="pageSettingsButton" data-toggle="modal" data-siteid="{{ $data['siteData']['site'][0]['id'] }}">
                                <span class="fui-arrow-right"></span>
                                Page Settings
                            </a>
                        </li>
                        <li class="divider"></li>
                            ...
                            <li>
                                <a href="{{ route('account.dashboard') }}" id="backButton">
                ...
                <a href="#exportModal" id="exportPage" data-toggle="modal" class="btn btn-inverse pull-right actionButtons slick" style="display: none">
                    ...
                    <span class="slide">Export</span>
                </a>

                <a href="#" id="publishPage" class="btn btn-inverse pull-right actionButtons slick" data-siteid="{{ $data['siteData']['site'][0]['id'] }}" <?php if( $data['siteData']['site'][0]['ftp_ok'] == 0 ):?>data-toggle="tooltip" data-placement="bottom" title="You can not publish your site right now. Please update your FTP details."<?php endif;?> style="display: none">
                    <i class="fui-upload"></i>
                    <span class="slide">Publish</span>
                    <i class="fui-alert text-danger" <?php if( $data['siteData']['site'][0]['ftp_ok'] == 1 ):?>style="display:none"<?php endif;?>>
                    </i>
                </a>

                <div class="btn-group slick" style="float: right; display: none" id="button_revisionsDropdown">
                    <button class="btn btn-inverse dropdown-toggle @if( ! $data['revisions']) disabled @endif" data-toggle="dropdown">
                        <i class="fui-windows"></i>
                        <span class="bLabel slide">Older versions</span>
                    </button>
                    <span class="dropdown-arrow dropdown-arrow-inverse"></span>
        ...
        <div id="styleEditor" class="styleEditor">
            ...
            <ul class="nav nav-tabs" id="detailTabs">
                ...
                <li style="display: none;"><a href="#video_Tab" id="video_Link"><span class="fa fa-youtube-square"></span> Video</a></li>
            </ul><!-- /tabs -->
        ...
        <div id="hidden">
            <iframe src="{{ URL('elements/skeleton.html') }}" id="skeleton"></iframe>
        </div>
        ...
        <div class="modal fade" id="exportModal" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <form action="{{ route('account.sitebuilder.export') }}" target="_blank" id="markupForm" method="post" class="form-horizontal">

                <input type="hidden" name="siteID" value="{{ $data['siteData']['site'][0]['id'] }}">
        ...
        <div class="modal fade publishModal" id="publishModal" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <form action="{{ route('account.sitebuilder.publish') }}" target="_blank" id="publishForm" method="post" class="form-horizontal">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="loader" style="display: none;">
                                <img src="{{ URL('assets/plugins/sitebuilder/images/loading.gif') }}" alt="Loading...">
                                Saving data...
                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <span class="publishing">
                                                            <span class="working">Publishing... <img src="{{ URL('assets/plugins/sitebuilder/images/publishLoader.gif') }}"></span>
                        ...
                        <div class="modal-body-content">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="uploadTab">
                                    ...
                                    <form id="imageUploadForm" action="{{ route('account.sitebuilder.image.upload.ajax') }}">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="{{ route('account.dashboard') }}" class="btn btn-primary btn-embossed" id="leavePageButton"><span class="fui-check"></span> Leave the page</a>
                </div>
    ...
    <div class="modal fade" id="previewModal" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <form action="{{ route('account.sitebuilder.live.preview') }}" target="_blank" id="markupPreviewForm" method="post" class="form-horizontal">
    ...
    <script src="{{ URL::to('assets/plugins/sitebuilder/js/vendor/jquery.min.js') }}"></script>
    <script src="{{ URL::to('assets/plugins/sitebuilder/js/vendor/jquery-ui.min.js') }}"></script>
    <script src="{{ URL::to('assets/plugins/sitebuilder/js/vendor/flat-ui-pro.min.js') }}"></script>
    <script src="{{ URL::to('assets/plugins/sitebuilder/js/vendor/chosen.min.js') }}"></script>
    <script src="{{ URL::to('assets/plugins/sitebuilder/js/vendor/jquery.zoomer.js') }}"></script>
    <script src="{{ URL::to('assets/plugins/sitebuilder/js/vendor/spectrum.js') }}"></script>
    <script src="{{ URL::to('assets/plugins/sitebuilder/js/vendor/summernote.min.js') }}"></script>
    <script src="{{ URL::to('assets/plugins/sitebuilder/js/vendor/ace/ace.js') }}"></script>
    <script src="{{ URL::to('assets/plugins/sitebuilder/js/build/builder.js') }}"></script>
