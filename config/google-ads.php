...
return [
    'ADWORDS' => [
        ...
        'clientCustomerId' => env('ADWORDS_CLIENT_CUSTOMER_ID'),
    ...
    'OAUTH2' => [
         ...
         */
         ...
         'clientId' => env('ADWORDS_CLIENT_ID'),
         'clientSecret' => env('ADWORDS_CLIENT_SECRET'),
         'refreshToken' => env('ADWORDS_CLIENT_REFRESH_TOKEN'),         
