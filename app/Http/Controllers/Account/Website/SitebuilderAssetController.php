...
class SitebuilderAssetController extends Controller
{
    /**
            ...
            if (in_array($ext, $tempExt)) {
                if ($file->move($userFolder, $file->getClientOriginalName())) {
                    ...
                    if (isset($userImages)) {
                        ...
                        $myImages = View('account.website.sitebuilder.partials.myimages', array('userImages' => $userImages, 'userSrc' => $userSrc, 'dataURL' => $dataURL));
